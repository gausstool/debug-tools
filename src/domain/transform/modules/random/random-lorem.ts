const LOREM_WORDS_BASE = [
  ...
  'dolores', 'eos', 'qui', 'ratione', 'sequi', 'nesciunt', 'neque', 'porro',
  'quisquam', 'numquam', 'eius', 'modi', 'tempora', 'incidunt', 'magnam', 'quaerat',
  'minima', 'nostrum', 'exercitationem', 'corporis', 'suscipit', 'laboriosam',
  'aliquid', 'commodi', 'consequatur', 'autem', 'vel', 'iure', 'reprehenderit',
  'quam', 'nihil', 'molestiae', 'illum', 'quo', 'voluptas', 'atvero', 'eos',
  'accusamus', 'iusto', 'odio', 'dignissimos', 'ducimus', 'blanditiis', 'praesentium',
  'voluptatum', 'deleniti', 'corrupti', 'quos', 'dolores', 'quas', 'molestias',
  'excepturi', 'sint', 'cupiditate', 'provident', 'similique', 'culpa', 'officia',
  'mollitia', 'animi', 'laborum', 'dolor', 'fuga', 'harum', 'quidem', 'rerum',
  'facilis', 'expedita', 'distinctio', 'nam', 'libero', 'tempore', 'cum', 'soluta',
  'nobis', 'eligendi', 'optio', 'cumque', 'nihil', 'impedit', 'quo', 'minus', 'id',
  'maxime', 'placeat', 'facere', 'possimus', 'omnis', 'voluptas', 'assumenda',
  'omnis', 'dolor', 'repellendus', 'temporibus', 'autem', 'officiis', 'debitis',
  ...
  'asperiores', 'repellat', 'integer', 'libero', 'felis', 'massa', 'justo', 'odio',
  'cursus', 'metus', 'vitae', 'ultricies', 'praesent', 'lectus', 'tortor',
  'condimentum', 'lacinia', 'quis', 'vel', 'eros', 'donec', 'sollicitudin', 'tellus',
  'cras', 'blandit', 'mi', 'porta', 'lacinia', 'sapien', 'quisque', 'porta', 'nisl',
  'eget', 'eleifend', 'quam', 'pellentesque', 'diam', 'arcu', 'curabitur',
  'aliquam', 'nibh', 'suscipit', 'at', 'semper', 'interdum', 'malesuada', 'fames',
  'ante', 'primis', 'faucibus', 'orci', 'luctus', 'ultrices', 'posuere', 'cubilia',
  'curae', 'mauris', 'viverra', 'morbi', 'nam', 'tincidunt', 'lacus', 'nunc',
  'molestie', 'elementum', 'tempus', 'risus', 'facilisi', 'fermentum', 'pretium',
  'hendrerit', 'ante', 'suspendisse', 'potenti', 'leo', 'eget', 'vitae', 'pretium',
  'tortor', 'condimentum', 'risus', 'nulla', 'facilisi', 'cras', 'fermentum',
  'odio', 'feugiat', 'pretium', 'libero', 'nunc', 'hendrerit', 'suspendisse',
  'potenti', 'sed', 'leo', 'eget', 'magna', 'semper', 'vitae', 'porta', 'lorem',
  'ipsum', 'neque', 'porro', 'quisquam', 'est', 'qui', 'dolorem', 'ipsum', 'quia',
  'dolor', 'amet', 'consectetur', 'adipisci', 'velit', 'sed', 'quia', 'non',
  'numquam', 'eius', 'modi', 'tempora', 'incidunt', 'labore', 'dolore', 'magnam',
  'aliquam', 'quaerat', 'voluptatem', 'enim', 'ad', 'minima', 'veniam', 'quis',
  'nostrum', 'exercitationem', 'ullam', 'corporis', 'suscipit', 'laboriosam', 'nisi',
  'aliquid', 'ex', 'ea', 'commodi', 'consequatur', 'quis', 'autem', 'vel', 'eum',
  'iure', 'reprehenderit', 'qui', 'ea', 'voluptate', 'velit', 'esse', 'quam',
  'nihil', 'molestiae', 'consequatur', 'vel', 'illum', 'qui', 'dolorem', 'eum',
  'fugiat', 'quo', 'voluptas', 'nulla', 'pariatur', 'at', 'vero', 'eos', 'accusamus',
  'iusto', 'odio', 'ducimus', 'blanditiis', 'praesentium', 'voluptatum', 'deleniti',
  ...
  'laborum', 'et', 'dolor', 'fuga', 'et', 'harum', 'quidem', 'rerum', 'facilis',
  'est', 'expedita', 'distinctio', 'nam', 'libero', 'tempore', 'cum', 'soluta',
  'nobis', 'est', 'eligendi', 'optio', 'cumque', 'nihil', 'impedit', 'quo', 'minus',
  'id', 'quod', 'maxime', 'placeat', 'facere', 'possimus', 'omnis', 'voluptas',
  'assumenda', 'omnis', 'dolor', 'repellendus', 'temporibus', 'autem', 'quibusdam',
  'aut', 'officiis', 'debitis', 'aut', 'rerum', 'necessitatibus', 'saepe',
  'eveniet', 'ut', 'et', 'voluptates', 'repudiandae', 'sint', 'molestiae', 'non',
...
const LOREM_WORDS = [...new Set(LOREM_WORDS_BASE)];
